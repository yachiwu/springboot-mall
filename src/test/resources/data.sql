...
-- Note user feature unit test 沒有使用到h2 資料庫中的資料，因為password 是加密過的資料，較不好新增
-- order , order_item
INSERT INTO `order` (user_id, total_amount, created_date, last_modified_date) VALUES (1, 500690, '2022-06-02 16:51:49', '2022-06-02 16:51:49');
-- 1. 蘋果（澳洲）/ price 30 / stock 10
-- 2. 蘋果（日本北海道）/ 300 / 5
-- 5. BMW/ 500000 / 3
INSERT INTO order_item (order_id, product_id, quantity, amount) VALUES (1, 1, 3, 90);
INSERT INTO order_item (order_id, product_id, quantity, amount) VALUES (1, 2, 2, 300);
